...
const electronLogo = "" + new URL("icon-Dg0qrvmv.png", import.meta.url).href;
function App() {
  const ipcHandle = () => window.electron.ipcRenderer.send("ping");
  return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("img", { alt: "logo", className: "logo", src: electronLogo }), /* @__PURE__ */ React.createElement("div", { className: "creator" }, "Powered by electron-vite"), /* @__PURE__ */ React.createElement("div", { className: "text" }, "Build an Electron app with ", /* @__PURE__ */ React.createElement("span", { className: "react" }, "React")), /* @__PURE__ */ React.createElement("p", { className: "tip" }, "Please try pressing ", /* @__PURE__ */ React.createElement("code", null, "F12"), " to open the devTool"), /* @__PURE__ */ React.createElement("div", { className: "actions" }, /* @__PURE__ */ React.createElement("div", { className: "action" }, /* @__PURE__ */ React.createElement("a", { href: "https://electron-vite.org/", target: "_blank", rel: "noreferrer" }, "Documentation")), /* @__PURE__ */ React.createElement("div", { className: "action" }, /* @__PURE__ */ React.createElement("a", { target: "_blank", rel: "noreferrer", onClick: ipcHandle }, "Send IPC"))));
}
